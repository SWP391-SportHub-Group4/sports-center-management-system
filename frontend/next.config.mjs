...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      ["/tai-khoan", "/account"],
      ["/hoi-vien", "/member-dashboard"],
      ["/hoi-vien/dang-ky-cua-toi", "/member-dashboard/my-registrations"],
      ["/hoi-vien/goi-cua-toi", "/member-dashboard/my-plans"],
      ["/hoi-vien/ho-so", "/member-dashboard/profile"],
      ["/hoi-vien/hoa-don", "/member-dashboard/invoices"],
      ["/hoi-vien/lich-lop", "/member-dashboard/class-schedule"],
      ["/hoi-vien/tap-luyen", "/member-dashboard/training"],
      ["/le-tan", "/receptionist"],
