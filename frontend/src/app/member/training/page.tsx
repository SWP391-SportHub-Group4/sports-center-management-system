    ...
    >
      <div className={styles.container}>
        ...
        <div className={styles.goalBanner}>
          ...
          <Link href="/member/profile" className={styles.profileLinkBtn}>
        ...
        {/* Tab Switcher */}
        <div className={styles.tabsBar} role="tablist" aria-label={language === "en" ? "Training sections" : "Mục rèn luyện"}>
          <button
            type="button"
            role="tab"
            id="tab-plans"
          ...
          >
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
              ...
              {language === "en" ? "Workout Regimens" : "Giáo án bài tập"}
            </span>
          ...
          >
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
              <IconChat size={18} />
              {language === "en" ? "Coach Logs & Feedback" : "Nhật ký & Nhận xét HLV"}
            </span>
        ...
        {activeTab === "plans" && (
          <div role="tabpanel" id="panel-plans" aria-labelledby="tab-plans">
            {plans.loading ? (
              ...
              <div className={styles.emptyCard}>
                <div className={styles.emptyIcon} style={{ background: 'none', border: 'none', padding: 0 }}>
                  <StickerTrainingEmpty size={110} />
                </div>
                <h3 className={styles.emptyTitle}>
                  {language === "en"
                ...
                <p className={styles.emptyDesc}>
                  {language === "en"
                    ? "Your assigned coach will prepare a customized workout routine based on your fitness level and goals. Speak with your coach in your next session or explore the center's class timetable!"
                    : "Huấn luyện viên phụ trách sẽ lập giáo án cá nhân hóa dựa trên thể lực và mục tiêu của bạn. Hãy trao đổi với HLV trong buổi tập tới hoặc tham khảo lịch lớp tại trung tâm!"}
                </p>
                <Link href="/member/class-schedule" className={styles.emptyActionBtn}>
          ...
          <div role="tabpanel" id="panel-results" aria-labelledby="tab-results">
            {results.loading ? (
              ...
              <div className={styles.emptyCard}>
                ...
                <p className={styles.emptyDesc}>
                  {language === "en"
                    ? "Following each group class or personal training session, your coach will document your strength progress and performance remarks here."
                    : "Sau mỗi buổi học hoặc buổi tập cá nhân, Huấn luyện viên sẽ ghi nhận tiến độ cơ lực và nhận xét phong độ của bạn tại đây."}
                </p>
                <Link href="/member/class-schedule" className={styles.emptyActionBtn}>
