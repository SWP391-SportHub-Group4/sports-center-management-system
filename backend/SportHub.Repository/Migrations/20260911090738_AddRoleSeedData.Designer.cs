...
namespace SportHub.Repository.Migrations
{
    ...
    [Migration("20260911090738_AddRoleSeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.AiLog", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Attendance", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Class", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.ClassRecurrence", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.ClassSession", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.CoachMemberRelationship", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Enrollment", b =>
                {
                    b.Property<Guid>("EnrollmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.MemberPackage", b =>
                {
                    b.Property<Guid>("MemberPackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.MemberTrainingProfile", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.MembershipPackage", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.PaymentAdjustment", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserAccount", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserCredential", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserExternalLogin", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.WorkoutPlan", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.WorkoutPlanItem", b =>
                {
                    b.Property<Guid>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.WorkoutResult", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.AiLog", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Attendance", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "CheckedInByUser")
                        .WithMany()
                        .HasForeignKey("CheckedInByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_attendances_user_accounts_checked_in_by_user_id");

                    b.HasOne("SportHub.Repository.Entities.Enrollment", "Enrollment")
                        .WithOne("Attendance")
                        .HasForeignKey("SportHub.Repository.Entities.Attendance", "EnrollmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Class", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "DefaultCoach")
                        .WithMany()
                        .HasForeignKey("DefaultCoachId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_classes_user_accounts_default_coach_id");

                    b.HasOne("SportHub.Repository.Entities.Room", "DefaultRoom")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.ClassRecurrence", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Class", "Class")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.ClassSession", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "Coach")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.CoachMemberRelationship", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "Member")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Enrollment", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "CancelledByUser")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.MemberPackage", "MemberPackage")
                    ...
                    b.HasOne("SportHub.Repository.Entities.ClassSession", "Session")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Invoice", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "IssuedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.InvoiceItem", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Invoice", "Invoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.MemberPackage", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.MembershipPackage", "Package")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "ReceivedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.PaymentAdjustment", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "ApprovedByUser")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.Payment", "Payment")
                        .WithMany("Adjustments")
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_payment_adjustments_payments_payment_id");

                    b.HasOne("SportHub.Repository.Entities.UserAccount", "RequestedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserAccount", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Role", "Role")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserCredential", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "UserAccount")
                        .WithOne("Credential")
                        .HasForeignKey("SportHub.Repository.Entities.UserCredential", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.UserProfile", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.UserAccount", "UserAccount")
                        .WithOne("Profile")
                        .HasForeignKey("SportHub.Repository.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.WorkoutPlan", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.CoachMemberRelationship", "Relationship")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.WorkoutPlanItem", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.WorkoutPlan", "Plan")
                        .WithMany("Items")
