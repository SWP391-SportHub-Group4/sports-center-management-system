...
namespace SportHub.Repository.Migrations
{
    ...
    [Migration("20260912083202_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.AI.AiLog", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.Role", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserAccount", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserCredential", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserExternalLogin", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserProfile", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Membership.MemberPackage", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Membership.MemberTrainingProfile", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Membership.MembershipPackage", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.Invoice", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.Payment", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.PaymentAdjustment", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Attendance", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Class", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.ClassRecurrence", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.ClassSession", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Enrollment", b =>
                {
                    b.Property<Guid>("EnrollmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.CoachMemberRelationship", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.WorkoutPlan", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.WorkoutPlanItem", b =>
                {
                    b.Property<Guid>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.WorkoutResult", b =>
                {
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.AI.AiLog", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserAccount", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.Role", "Role")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserCredential", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "UserAccount")
                        .WithOne("Credential")
                        .HasForeignKey("SportHub.Repository.Entities.Identity.UserCredential", "UserId")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Identity.UserProfile", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "UserAccount")
                        .WithOne("Profile")
                        .HasForeignKey("SportHub.Repository.Entities.Identity.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Membership.MemberPackage", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "Member")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.Membership.MembershipPackage", "Package")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.Invoice", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "IssuedByUser")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.Membership.MemberPackage", "MemberPackage")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.InvoiceItem", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Payment.Invoice", "Invoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.Payment", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "ReceivedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Payment.PaymentAdjustment", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "ApprovedByUser")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.Payment.Payment", "Payment")
                        .WithMany("Adjustments")
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_payment_adjustments_payments_payment_id");

                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "RequestedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Attendance", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "CheckedInByUser")
                        .WithMany()
                        .HasForeignKey("CheckedInByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_attendances_user_accounts_checked_in_by_user_id");

                    b.HasOne("SportHub.Repository.Entities.Scheduling.Enrollment", "Enrollment")
                        .WithOne("Attendance")
                        .HasForeignKey("SportHub.Repository.Entities.Scheduling.Attendance", "EnrollmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Class", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "DefaultCoach")
                        .WithMany()
                        .HasForeignKey("DefaultCoachId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_classes_user_accounts_default_coach_id");

                    b.HasOne("SportHub.Repository.Entities.Scheduling.Room", "DefaultRoom")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.ClassRecurrence", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Scheduling.Class", "Class")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.ClassSession", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "Coach")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.Scheduling.ClassRecurrence", "Recurrence")
                        .WithMany("Sessions")
                        .HasForeignKey("RecurrenceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_class_sessions_class_recurrences_recurrence_id");

                    b.HasOne("SportHub.Repository.Entities.Scheduling.ClassSession", "RescheduledFromSession")
                        .WithMany()
                        .HasForeignKey("RescheduledFromSessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_class_sessions_class_sessions_rescheduled_from_session_id");

                    b.HasOne("SportHub.Repository.Entities.Scheduling.Room", "Room")
                        .WithMany("Sessions")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Enrollment", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Identity.UserAccount", "CancelledByUser")
                        .WithMany()
                    ...
                    b.HasOne("SportHub.Repository.Entities.Scheduling.ClassSession", "Session")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.CoachMemberRelationship", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Scheduling.Class", "Class")
                        .WithMany("CoachMemberRelationships")
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.WorkoutPlan", b =>
                {
                    ...
                    b.HasOne("SportHub.Repository.Entities.Training.CoachMemberRelationship", "Relationship")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Training.WorkoutPlanItem", b =>
                {
                    b.HasOne("SportHub.Repository.Entities.Training.WorkoutPlan", "Plan")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SportHub.Repository.Entities.Scheduling.Class", b =>
                {
                    b.Navigation("CoachMemberRelationships");
